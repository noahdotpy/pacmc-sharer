def main():
    ...
    group.add_argument('--short', '-s', action='store_true', default=False,
                       help='Used to get a short, one-line version of the normal script code (easier to copy/paste).')
    group.add_argument('--no-file', '-nf', action='store_true',
                       default=False, help='Use this if you don\'t want a file to be created.')
    group.add_argument('--copy', '-c', action='store_true',
                       default=False, help='Use this to copy the script to system clipboard.')
